        ...
        <div class="all">
            <div class="a_header">
                ...
                <form>
                    <div class="w_h_links">
                    <div class="a_h_radio">
                        <input id="r1" type="radio" name="type" checked>
                        <label for="r1">Усі експонати</label>
                    </div>
                    <div class="a_h_radio">
            ...
            <div class="showcase">
                <?php
                    ...
                    $query="SELECT name, photo FROM collection";
                    ...
                    foreach($result as $row) {
                        ...
                        if (!file_exists($image)) $image ='media/sakhnovski/'.$row['photo'];
