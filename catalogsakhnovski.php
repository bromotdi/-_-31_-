        ...
        <div class="all">
            <div class="a_header">
                ...
                <form>
                    ...
                    <div class="a_h_radio">
                        <input id="r2" type="radio" name="type" checked>
                        <label for="r2">Дім Сахновських</label>
                    </div>
                    <div class="a_h_radio">
                        <input id="r3" type="radio" name="type">
                        <a href="catalogkhanenko.php" onclick="document.getElementById('a_h_radio').submit()">Дім Ханенків</a>
                    </div>
                </div>
                </form>
            </div>
            <div class="showcase">
                <?php
                    ...
                    $query="SELECT name, photo FROM collection LEFT JOIN collection_name ON collection_name.id_collection=collection.id_collection WHERE name_collection = 'Дім Сахновських'";
